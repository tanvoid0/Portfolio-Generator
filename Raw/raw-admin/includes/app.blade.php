...
<div id="pcoded" class="pcoded">
  ...
  <!-- modernizr js -->
  <script type="text/javascript" src="{{ asset('assets/admin/js/modernizr.js') }}"></script>
  <!-- am chart -->
  <script src="{{ asset('assets/admin/js/amcharts.min.js') }}"></script>
  <script src="{{ asset('assets/admin/js/serial.min.js') }}"></script>
  <!-- Chart js -->
  <script type="text/javascript" src="{{ asset('assets/admin/js/Chart.js') }}"></script>
  <!-- Todo js -->
  <script type="text/javascript " src="{{ asset('assets/admin/js/todo.js') }}"></script>
  <!-- Custom js -->
  <script type="text/javascript" src="{{ asset('assets/admin/js/custom-dashboard.min.js') }}"></script>
