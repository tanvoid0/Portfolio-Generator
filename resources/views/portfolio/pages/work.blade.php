        ...
        <div class="container content-lg">
            <div class="row">
                ...
                <div class="col-sm-8 col-sm-offset-1">
                        ...
                        @if(count($works) > 0)
                            ...
                            @foreach ($works as $work)
                                <div class="col-md-4 md-margin-b-4" style="padding: 20px;">
                                    <div class="work work-popup-trigger" data-toggle="tooltip"
                                            ...
                                            <div class="work-popup-content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="margin-t-10 sm-margin-t-0">
                                                            <p class="margin-b-5">
                                                                <strong>Title:</strong>{{$work->title}}</p>
                                                            <p class="margin-b-5">
                                                                <strong>Category:</strong>{{ $work->category }}</p>
                                                            @if($work->link != "")
                                                                <p class="margin-b-5"><strong><a href="{{$work->link}}"
                                    ...
                                    @if($panel)
                                        <button type="button" class="btn btn-default" data-toggle="modal"
                                                data-target="#work-edit-{{ $work->id }}"><i
                                                    class="glyphicon glyphicon-pencil"></i></button>
                                        <div class="modal fade" id="work-edit-{{ $work->id }}" tabindex="-1"
                                             role="dialog" aria-labelledby="work-edit-{{ $work->id }}Label"
                                             aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="work-edit-{{ $work->id }}Label">
                                                            Update Works</h5>
                                                    ...
                                                    <form role="form" action="{{ route('work.update', $work->id) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="box-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="image"
                                                                           class="form-control col-sm-4 col-form-label">Upload
                                                                        Project Image</label>
                                                                    <div class="col-sm-8">
                                                                        <input type="file" id="image" name="image"
                                                                               class="dropify"
                                                                               data-default-file="{{ asset('img/work/'.$work->image) }}"/>
                                                                    </div>
                                                                </div>
                                        ...
                                        <form id="delete-form-{{ $work->id }}" method="post"
                                              action="{{ route('work.destroy', $work->id) }}" style="display: none;">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
                                        </form>
                                        ...
                                        <a onclick="
                                                ...
                                                ">
                                            <button type="button" class="btn btn-default"><i class="icon-trash"></i>
                                            </button>
                                        </a>
                                    @endif
                                </div>
                    ...
                    <!--// end row -->
                    @if($panel)
                        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#work-add"><i
                                    class="glyphicon glyphicon-plus"></i> Add Works
                        </button>
                        <!-- Modal -->
                        <div class="modal fade" id="work-add" tabindex="-1" role="dialog" aria-labelledby="work-addLabel"
                             aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <form role="form" action="{{ route('work.store') }}" method="post">
                                        {{ csrf_field() }}
                                        <div class="modal-body">
                                            <div class="box-body">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="link">Link</label>
                                                    <input type="url" class="form-control" id="link" name="link" placeholder="Link" value="">
                                                </div>
                                            </div>
