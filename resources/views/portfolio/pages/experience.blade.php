                                ...
                                <div class="col-md-4 md-margin-b-4">
                                    <div class="service" data-height="height">
                                        ...
                                        <div class="service-info">
                                            <h2 class="margin-b-5" style="color: #17bed2">{{ $experience->company}}</h2>
                                            <p>
                                        ...
                                        @if($panel)
                                            <button type="button" class="btn btn-default" data-toggle="modal"
                                                    data-target="#exp-edit-{{ $experience->id }}"><i
                                                        class="glyphicon glyphicon-pencil"></i></button>

                                            <div class="modal fade" id="exp-edit-{{ $experience->id }}" tabindex="-1"
                                                 role="dialog" aria-labelledby="exp-edit-{{ $experience->id }}Label"
                                                 aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="exp-edit-{{ $experience->id }}Label">Edit
                                                                Experience</h5>
                                            ...
                                            <form id="delete-form-{{ $experience->id }}" method="post"
                                    ...
                                    <form role="form" action="{{ route('experience.store') }}" method="post">
                                        ...
                                        <div class="modal-body">
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="description">Description</label>
                                                    <textarea class="form-control" id="description" maxlength="300"
                                                              name="description"
