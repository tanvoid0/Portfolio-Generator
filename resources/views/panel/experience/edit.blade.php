            ...
            <div class="box-body">
              <div class="col-lg-offset-3 col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" id="start_year" name="start_year" placeholder="Start Year"
                         value="{{ $experience->start_year }}">
                </div>
                
                <div class="form-group">
                  <label for="end_year">End Year</label>
                  <input type="date" class="form-control" id="end_year" name="end_year" placeholder="End Year"
